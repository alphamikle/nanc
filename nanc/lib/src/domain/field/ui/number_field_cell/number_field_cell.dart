...
class _NumberFieldCellState extends State<NumberFieldCell> with FieldCellHelper<NumberField, NumberFieldCell> {
  String get placeholder {
    return switch ((field.numberType, field.signType)) {
      ...
      (NumberType.float, SignType.signed) => '-1234.00...1234.00',
      (NumberType.float, SignType.unsigned) => '1234.00',
      (NumberType.double, SignType.signed) => '-1234.00...1234.00',
      (NumberType.double, SignType.unsigned) => '1234.00',
