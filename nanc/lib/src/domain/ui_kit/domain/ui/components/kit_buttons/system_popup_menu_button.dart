...
typedef PopupMenuButtonChildBuilder = Widget Function(BuildContext context, VoidCallback onPressed);

class SystemPopupMenuButton<T> extends StatefulWidget {
  /// Creates a button that shows a popup menu.
  ///
  /// The [itemBuilder] argument must not be null.
  const SystemPopupMenuButton({
  ...
  final PopupMenuButtonChildBuilder? childBuilder;
  ...
  @override
  SystemPopupMenuButtonState<T> createState() => SystemPopupMenuButtonState<T>();
}

class SystemPopupMenuButtonState<T> extends State<SystemPopupMenuButton<T>> {
  /// A method to show a popup menu with the items supplied to
  /// [SystemPopupMenuButton.itemBuilder] at the position of your [SystemPopupMenuButton].
  ///
  /// By default, it is called when the user taps the button and [SystemPopupMenuButton.enabled]
  /// is set to `true`. Moreover, you can open the button by calling the method manually.
  ///
  /// You would access your [SystemPopupMenuButtonState] using a [GlobalKey] and
  ...
  void showButtonMenu() {
    ...
    switch (popupMenuPosition) {
      ...
      case PopupMenuPosition.under:
        offset = Offset(0, button.size.height - (widget.padding.vertical / 2)) + widget.offset;
        break;
    }
