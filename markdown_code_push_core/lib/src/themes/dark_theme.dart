...
import 'package:markdown_code_push_core/src/config/highlight_themes.dart';

final Map<String, Object> darkThemeMap = {
  'PStyle': const TextStyle(color: Color(0xffFAFAFA)),
  'CodeStyle': TextStyle(fontSize: 12, color: const Color(0xffFAFAFA), background: _getCodePaint()),
